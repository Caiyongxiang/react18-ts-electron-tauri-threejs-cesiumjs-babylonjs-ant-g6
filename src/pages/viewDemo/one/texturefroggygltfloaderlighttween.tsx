...
const codes = [
  {
    p: `HDR贴图（High Dynamic Range Image）<br>
...
在同样的游戏森林场景中，随着你视线向远方延伸，树木被雾笼罩的程度更为自然、平滑。即使在近处，雾的效果也会有所体现，但不会像线性雾那样突然变化，而是逐渐加强。这就是指数雾的效果。`,
    language: 'javascript',
    value: `  scene.fog = new THREE.Fog(0x999999, 0.1, 50)
    // 创建场景指数fog
  ...
  },
  {
    p: `tween 补间动画`,
    language: 'javascript',
    value: `    const tween = new TWEEN.Tween(sphere1.position)
    tween.to({ x: 40 }, 1000)
    tween.onUpdate(() => {
...
const texturefroggygltfloaderlighttween = () => {
...
export default texturefroggygltfloaderlighttween
